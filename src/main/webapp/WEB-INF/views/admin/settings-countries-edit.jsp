					...
					<c:if test="${not empty country.createdBy}">
						<table class="info">
							<tr>
								...
								<td class="val"><joda:format value="${country.created}" pattern="${common.dateTimeFormat}"/></td>
							</tr>
							...
							<tr>
								...
								<td class="val"><joda:format value="${country.changed}" pattern="${common.dateTimeFormat}"/></td>
							</tr>
							</c:if>
						</table>
					</c:if>
