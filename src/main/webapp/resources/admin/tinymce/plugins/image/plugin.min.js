...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function openFileManager(){
				...
				params = '?uploadType=1&selector=' + win.find('#src')[0]._id;
				openedWin = window.open(getBasePath() + 'admin/file-manager.htm'+params, 'filemanager' ,'width=732,height=540,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=no,top='+top+',left='+left);
				openedWin.focus();
		}
