	...
	function showDialog(imageList) {
		...
		function openFileManager(){
				...
				if(fileDirSelector.length > 0){
					dirName = "?dir=" +  fileDirSelector.text();
				}
				window.open($("#base").text() + 'admin/file-manager.htm'+dirName,'' ,'width=800,height=540 ,toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no');
		}
