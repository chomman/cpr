...
tinymce.PluginManager.add('image', function(editor) {
	...
	function showDialog(imageList) {
		...
		function openFileManager(){
				...
				var params = '',
					openedWin,
					fileDirSelector = $('#fileDir'),
					left = ($(document).width()/2)-(800/2),
					top = ($(document).height()/2)-(500/2);
				params = '?selector=' + win.find('#src')[0]._id;
				if(fileDirSelector.length > 0){
					params += "&dir=" +  fileDirSelector.text();
				}
				console.log('params: ' + params);
				openedWin = window.open($("#base").text() + 'admin/file-manager.htm'+params, 'filemanager' ,'width=732,height=540,toolbar=no,status=no,menubar=no,scrollbars=yes,resizable=no,top='+top+',left='+left);
				openedWin.focus();
		}
