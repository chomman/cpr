...
function loadWidget(){var e=document.getElementsByClassName("nlf-iframe");for(var t=0;t<e.length;t++){e[t].src=e[t].getAttribute("data-url")}iFrameResize({heightCalculationMethod:"bodyScroll"})}if(!Array.prototype.forEach){Array.prototype.forEach=function(e){"use strict";if(this===void 0||this===null||typeof e!=="function")throw new TypeError;var t=Object(this),n=t.length>>>0,r=arguments.length>=2?arguments[1]:void 0;for(var i=0;i<n;i++)if(i in t)e.call(r,t[i],i,t)}}setTimeout(loadWidget,5)