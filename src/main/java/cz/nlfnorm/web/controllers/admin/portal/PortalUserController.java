...
public class PortalUserController extends AdminSupportController {
	...
	public String processUserEdit(@Valid @ModelAttribute("user") User form, BindingResult result, ModelMap map) throws ItemNotFoundException{
	...
	private User update(User form) throws ItemNotFoundException{
	...
	private void prepareModel(ModelMap map, User user){
