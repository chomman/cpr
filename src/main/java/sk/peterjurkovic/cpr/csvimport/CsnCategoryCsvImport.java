...
public class CsnCategoryCsvImport implements CsvImport{
	...
	private int processReadFile(CSVReader reader){
		...
		try {
			...
			logger.info("Import csv souboru zlyhal. Poradilo ca importovat pocet kategorii: " + coutner + " dovod: " + e.getMessage());
		}
		return coutner;
	}
